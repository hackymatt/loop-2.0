  ...
  return [
    {
      ...
      content: (
        <Typography>
          <Typography>
            1. Serwis internetowy — serwis znajdujący się pod adresem niniejszej strony
            internetowej, za pośrednictwem którego Sprzedawca świadczy usługi drogą elektroniczną.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            prawną, która zawarła lub zamierza zawrzeć umowę o świadczenie usług.
          </Typography>
          <Typography>
          ...
          <Typography>
            8. Zamówienie — oświadczenie woli Klienta, złożone za pośrednictwem Serwisu
            internetowego określające: rodzaj i zakres Usługi dostępnej w Serwisie internetowym w
            chwili składania zamówienia, sposób zapłaty oraz dane Klienta.
          </Typography>
          <Typography>
      ...
      content: (
        <Typography>
          <Typography>
            ...
            przetwarzanie przez Sprzedawcę danych osobowych wyłącznie w celu bezpośrednio związanym
            z realizacją zamówionej usługi w Serwisie internetowym. Szczegółowe warunki gromadzenia,
            przetwarzania oraz ochrony danych osobowych przez Sprzedawcę określone zostały w
            „Polityce prywatności” Serwisu internetowego.
          </Typography>
          <Typography>
            2. Sprzedawca oświadcza, że usługi są zgodne z umową, w aspektach takich jak opis,
            rodzaj, jakość i funkcjonalność, a w odniesieniu do usług cyfrowych — również
            kompatybilność, interoperacyjność i dostępność aktualizacji; ale również przydatność do
            szczególnego celu, do którego jest potrzebny konsumentowi, o którym konsument powiadomił
            przedsiębiorcę najpóźniej w momencie zawarcia umowy i który przedsiębiorca zaakceptował.
            Ponadto, aby usługa została uznana za zgodną z umową.
          </Typography>
          <Typography>
            ...
            zapewniono, aby publikowane opinie pochodziły od konsumentów, którzy używali danej
            usługi lub z niej skorzystali. Środki podjęte w tym celu muszą być konkretnie
            wymienione.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            <Typography sx={{ ml: 3 }}>
              • Fałszowanie opinii w Internecie — doświadczenia konsumentów, na podstawie badania
            ...
            <Typography sx={{ ml: 3 }}>
              ...
              97/7/WE, 98/27/WE i 2002/65/WE Parlamentu Europejskiego i Rady oraz rozporządzenie
              (WE) nr 2006/2004 Parlamentu Europejskiego i Rady („Dyrektywa o nieuczciwych
              praktykach handlowych”) (OJ L 149, 11.06.2005, p. 22—39, z późn. zmianami).{" "}
            </Typography>
            <Typography sx={{ ml: 3 }}>
              • Zawiadomienie Komisji — Wytyczne dotyczące wykładni i stosowania dyrektywy
              2005/29/WE Parlamentu Europejskiego i Rady dotyczącej nieuczciwych praktyk handlowych
              stosowanych przez przedsiębiorstwa wobec konsumentów na rynku wewnętrznym, OJ C 526,
              29.12.2021, s. 1—129.{" "}
            </Typography>
            <Typography sx={{ ml: 3 }}>
              ...
              dyrektywę 97/7/WE Parlamentu Europejskiego i Rady (OJ L 304, 22.11.2011, p. 64—88, z
              późn. zmianami).
            </Typography>
          </Typography>
          <Typography>
          ...
          <Typography>
            7. Administrator danych stosuje odpowiednie środki techniczne i organizacyjne
            zapewniające ochronę danych osobowych odpowiednio do zagrożeń oraz kategorii danych
          ...
          <Typography>
            ...
            <Typography sx={{ ml: 3 }}>
              • Uzyskania informacji o celu, zakresie, sposobie, czasie przetwarzania danych
          ...
          <Typography>
            ...
            osoby charakteru zawodowego, wynikającego w szczególności z przedmiotu wykonywanej przez
          ...
          <Typography>
            ...
            abuzywnych zawarty jest w art. 385(3) k.c.
          </Typography>
          <Typography>
            24. Przedsiębiorcy prowadzący jednoosobowo działalność gospodarczą po zmianach opisanych
            powyżej nadal nie mogą korzystać z pomocy instytucji wspierających konsumentów w
            ochronie ich praw, w tym z pomocy Powiatowych/Miejskich Rzeczników Konsumenta czy UOKIK.
          </Typography>
        </Typography>
      ),
    },
      ...
      content: (
        <Typography>
          ...
          <Typography>
            ...
            wypełnienia formularza zamówienia Klientowi Serwisu internetowego. Umowa zawierana jest
            na czas oznaczony w momencie przystąpienia przez Klienta do wypełnienia formularza oraz
          ...
          <Typography>
            3. Usługa określona w pkt. 1 świadczona jest nieodpłatnie, może wymagać jednak dostępu
          ...
          <Typography>
            ...
            zgodę na przetwarzanie moich danych osobowych zawartych w formularzu w celu i zakresie
          ...
          <Typography>
            ...
            wyłącznie przez Klienta zgodnie z taryfą swojego dostawcy, z którym klient podpisał
      ...
      content: (
        <Typography>
          <Typography>
            ...
            dokonuje wyboru zgodnie z wyświetloną ofertą Serwisu internetowego określając ilość
            Usług jakie zamierza nabyć oraz w razie takiej możliwości wskazując cechy zamawianej
            Usługi oraz odpowiednio jej specyfikację. Łącznie z wyborem Usługi, Klient wypełnia
            formularz zamówienia, wskazując w nim dane niezbędne do realizacji zamówienia przez
            Sprzedawcę takie jak na przykład ilości, miejsce dostawy oraz formy płatności, w oparciu
            o wyświetlane Klientowi komunikaty i informacje dostępne na stronie oraz zawarte w
          ...
          <Typography>
            ...
            przyjęcie zamówienia poprzez wysłanie na podany podczas składania zamówienia adres
            e-mail, wiadomości opisującej przedmiot zamówienia. W przypadku podania niepełnych,
            błędnych, sprzecznych informacji przez Klienta/Przedsiębiorcę podczas składania
            zamówienia, Serwis skontaktuje się z Klientem/Przedsiębiorcą w celu usunięcia błędów.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            Usługi bądź wybiera odpowiednią specyfikację Usługi z podanych przez Sprzedawcę
            wariantów dostępnych możliwości konfiguracji danej Usługi.
          </Typography>
          <Typography>
            ...
            otrzymania wiadomości przez Klienta dochodzi do zawarcia umowy o świadczenie usług.
          </Typography>
          <Typography>
            7. Wiadomość podsumowująca i potwierdzająca zamówienie zawiera wszystkie wcześniej
            ustalone warunki umowy o świadczenie usług, a w szczególności ilość oraz rodzaj
            zamówionej Usługi, jej specyfikację w przypadku zamówienia Usług o indywidualnych
            właściwościach określonych przez Klienta Serwisu internetowego, całkowitą cenę do
            zapłaty (określoną w polskich złotych) wraz z kosztami dodatkowymi oraz wysokością
    ...
    },
    {
      ...
      content: (
        <Typography>
          ...
          <Typography>
            2. Czas realizacji zamówienia dla pojedynczego Klienta określany jest na stronie
            produktu. Czas dostępu do usługi zależy od jej specyfiki i jest określony w opisie
            usługi.
          </Typography>
          <Typography>
    ...
    },
    {
      ...
      content: (
        <Typography>
          <Typography>
            1. Dostawa w rozumieniu niniejszego regulaminu odnosi się do dostarczenia usługi, co
            może obejmować dostęp do materiałów szkoleniowych, transmisji online lub innego rodzaju
          ...
          <Typography>
            3. Usługa zawsze jest udostępniona w sposób odpowiadający jej właściwościom, tak aby
            była dostępna w pełnym zakresie i zgodna z opisem.
          </Typography>
          <Typography>
    ...
    },
    {
      ...
      content: (
        <Typography>
          <Typography>
            1. W przypadku roszczeń dotyczących usług Sprzedawca odpowiada za zgodność usługi z
            umową, zgodnie z obowiązującymi przepisami prawa.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            reklamacji. Reklamacje należy składać drogą elektroniczną na adres mailowy Sprzedawcy
            lub w formie pisemnej na adres pocztowy Sprzedawcy. Jeśli konsument ma trudności i nie
            wie, jak skonstruować zgłoszenie o wadach usługi, zgłoszenie może przesłać dla przykładu
            na formularzu stanowiącym załącznik nr 2 do niniejszego Regulaminu, co stanowi tylko
            ułatwienie dla procesu reklamacji, nie stanowi żadnego wymogu korzystania z w/w wzorca
            dla skuteczności reklamacji.
          </Typography>
          <Typography>
            4. Sprzedawca odpowiada za niezgodność usługi z umową, w przypadku jej stwierdzenia
            przed upływem dwóch lat od wykonania usługi.
          </Typography>
          <Typography>
            5. Sprzedawca pokrywa koszty związane z usunięciem wad usługi lub jej ponownym
            wykonaniem.
          </Typography>
        </Typography>
      ),
      ...
      content: (
        <Typography>
          <Typography>
            ...
            przysługuje prawo do odstąpienia od umowy zawartej na odległość bez podawania przyczyny.
          </Typography>
          <Typography>
            ...
            rozpoczęło się za wyraźną zgodą konsumenta przed upływem terminu do odstąpienia od umowy
            i po poinformowaniu go przez przedsiębiorcę o utracie prawa odstąpienia od umowy.” — w
          ...
          <Typography>
            ...
            formularzu stanowiącym załącznik nr 1 do niniejszego Regulaminu, przesyłając je drogą
            elektroniczną lub na adres pocztowy Sprzedawcy według wyboru Klienta. Załącznik nr 1
            stanowi tylko pomoc w odstąpieniu od umowy, nie jest wzorem koniecznym do skorzystania z
            prawa do odstąpienia od umowy. Klient może, ale nie musi z niego korzystać. Dla
            skutecznego odstąpienia wystarczy przesłanie oświadczenia na piśmie na adres Sprzedawcy.
          </Typography>
          <Typography>
    ...
    },
    {
      ...
      content: (
        <Typography>
          <Typography>
            1. Dla prawidłowego złożenia reklamacji Klient powinien podać swoje dane takie jak: imię
            i nazwisko lub nazwę firmy, adres zamieszkania lub adres siedziby firmy oraz adres
            ...
            złożenie reklamacji (opis na czym ona polega) ewentualnie jakich cech usługa zamawiana
            nie posiada, a według zapewnień Sprzedawcy lub według sposobu przedstawienia go
            Klientowi miała posiadać.
          </Typography>
          <Typography>
            ...
            żądać również usunięcia wad usług cyfrowych, a jeżeli usunięcie wady będzie
            nieskuteczne, może żądać obniżenia ceny lub odstąpić od umowy. Przy ocenie nadmierności
            kosztów uwzględnia się wartość usługi wolnej od wad, rodzaj i znaczenie stwierdzonej
      ...
      content: (
        <Typography>
          <Typography>
            ...
            nimi, jest jedynie podmiotem, który udostępnia zasoby teleinformatyczne. Klient
            oświadcza, że:
            <Typography sx={{ ml: 3 }}>
          ...
          <Typography>
            ...
            władzy Państwowej Sprzedawca zastrzega sobie prawo do modyfikowania lub usuwania treści
    ...
    },
    {
      ...
      content: (
        <Typography>
          <Typography>
            1. Informacje o pozasądowych sposobach rozpatrywania reklamacji i dochodzenia roszczeń,
            a także zasady dostępu do tych procedur udostępniane są w siedzibach oraz na stronach
            internetowych powiatowych (miejskich) rzeczników Konsumentów, organizacji społecznych,
            ...
            Konsumentów: www.uokik.gov.pl/spory_konsumenckie.php, www.uokik.gov.pl/wazne_adresy.php,
          ...
          <Typography>
            ...
            sporów (platforma ODR), zgodnie z rozporządzeniem Parlamentu Europejskiego i Rady (UE)
          ...
          <Typography>
            ...
            ma charakter dobrowolny i może mieć miejsce tylko, gdy obie strony sporu tj. Sprzedawca
            i Klient wyrażą na to zgodę.
          </Typography>
        </Typography>
      ),
    },
    {
      ...
      content: (
        <Typography>
          ...
          <Typography>
            4. Sprzedawca ma prawo ograniczyć dostępne sposoby płatności do kilku bądź do jednego,
            za poszczególne bądź wszystkie towary. Sprzedawca może wymagać dokonania przedpłaty w
          ...
          <Typography>
            8. Odpowiedzialność sprzedawcy jest ograniczona w ramach pojedynczego roszczenia, jak i
            za wszystkie roszczenia w sumie, do wysokości zapłaconej. Sprzedawca ponosi
    ...
    },
    {
      ...
      content: (
        <Typography>
          ...
          <Typography>
            3. Wszelkie treści zamieszczone na stronie Serwisu internetowego (wliczając w to
          ...
          <Typography>
            ...
            <Typography sx={{ ml: 3 }}>
              • Osoba podająca swoje dane osobowe ma nieograniczone prawo dostępu do wszystkich
              treści swoich danych i ich sprostowania, usunięcia (prawo do bycia zapomnianym),
              ograniczenia przetwarzania, prawo do przenoszenia danych, prawo do cofnięcia zgody w
              dowolnym momencie bez wpływu na zgodność z prawem przetwarzania, dane mogą być
              udostępnione jednak właściwym organom państwa w sytuacji, gdy odpowiedni przepis tego
              będzie wymagał.
            </Typography>
            <Typography sx={{ ml: 3 }}>
            ...
            <Typography sx={{ ml: 3 }}>
              ...
              okres to okres reklamacji i 1 rok na ewentualnie inne roszczenia i sytuacje
              wyjątkowe).
            </Typography>
            <Typography sx={{ ml: 3 }}>
              • Osoba udostępniająca swoje dane osobowe ma prawo wniesienia skargi do UODO, gdy
              uzna, że przetwarzanie danych osobowych dotyczących realizacji zamówienia narusza
          ...
          <Typography>
            6. Zmieniony Regulamin wiąże Klientów, jeżeli zostały zachowane wymagania określone w
            art. 384 Kodeksu cywilnego (tj. Klient został prawidłowo powiadomiony o zmianach).
          </Typography>
          <Typography>
            7. Sprzedawca zastrzega sobie prawo do dokonywania zmian Regulaminu z ważnych przyczyn
            to jest:
    ...
    },
    {
      ...
      content: (
        <Typography>
          ...
          niewyłącznego i niezbywalnego prawa do wykorzystywania tego Regulaminu Sprzedaży do celów
          związanych z własną działalnością handlową w Internecie oraz rozciąga ochronę prawną na
          w/w dokument na czas trwania umowy. Kopiowanie oraz rozpowszechnianie wzorca niniejszego
          Regulaminu Sprzedaży bez zgody Kancelarii Prawnej LEGATO jest zabronione i może podlegać
          odpowiedzialności zarówno karnej jak i cywilnej. Sprzedawcy internetowi mogą dowiedzieć
          się więcej o możliwości korzystania z wzorca Regulaminu Sprzedaży na stronie
