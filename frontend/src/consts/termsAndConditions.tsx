    ...
    content: (
      <Typography>
        ...
        <Typography>
          ...
          <Link target="_blank" rel="noopener" href={paths.eLearning.contact} color="text.primary">
            kontakt
          </Link>
          ).
        </Typography>
    ...
    content: (
      <Typography>
        ...
        <Typography>
          ...
          <Link target="_blank" rel="noopener" href={paths.eCommerce.cart} color="text.primary">
            koszyk
          </Link>
          ).
        </Typography>
